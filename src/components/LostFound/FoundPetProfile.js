  ...
  return (
    <div className="home-page__container hotels">
      <h2 className="home-page__title">
        Found pet: <span className="pet-type">Cat</span>
      ...
      <div className="home-page__row hotels__content">
        <article className="card card-more">
          <div className="card-more__img">
            {" "}
            <img src="/assets/images/found-pet.png" />
          </div>
          <div className="card-more__info">
            <h3 className="card-more__title">
              <span>Dog</span>, <span>Cat</span>
            </h3>
            ...
            <div className="card-more__item">
              <span>Distinctive features:</span> blue collar with stars, no left
              ear, damaged tail. Junk MTV quiz graced by
            </div>
          </div>
          <div className="card-more__description">
            <div className="card-more__item">
              ...
              whelps. Bawds jog, flick quartz, vex nymphs. raced by fox whelps.
